...
Dim Combo_RS, Dat, Saldo0, TMP_Lic, Perebor, GoodL, TMP As ADODB.Recordset
...
Dim SaldoNa As Double, SaldoKn As Double, Начислено As Double, Удержано As Double
