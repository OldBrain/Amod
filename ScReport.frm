...
Begin VB.Form ScReport 
   ...
   Begin VB.OptionButton Option2 
      BackColor       =   &H00C0C0C0&
      Caption         =   "Только л/сч имеющие счетчики"
      BeginProperty Font 
         Name            =   "MS Sans Serif"
         Size            =   7.8
         Charset         =   204
...
Addrconn.Open ("SELECT Kategor.Код, Kategor.Name_Kategor From Kategor ORDER BY Kategor.Код")
...
Combo1.AddItem Trim(Str(Addrconn("КОД"))) + " " + Addrconn("Name_Kategor")
End If
Addrconn.MoveNext
Loop
