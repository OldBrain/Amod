...
Begin VB.Form Kzatrat 
   BackColor       =   &H00FFFFFF&
   Caption         =   "Справочник статей затрат (ФАКТ)"
   ClientHeight    =   6672
   ClientLeft      =   168
   ClientTop       =   468
   ClientWidth     =   7500
   ...
   Begin VSFlex8Ctl.VSFlexGrid FG1 
      ...
      FormatString    =   $"Kzatrat.frx":4DF7D
      ScrollTrack     =   0   'False
      ScrollBars      =   2
      ScrollTips      =   0   'False
      MergeCells      =   0
   ...
   Begin MSComctlLib.ImageList imlToolbarIcons 
      ...
      BeginProperty Images {2C247F25-8591-11D1-B16A-00C0F0283628} 
         ...
         BeginProperty ListImage1 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Kzatrat.frx":4E073
            Key             =   "New"
         EndProperty
         BeginProperty ListImage2 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Kzatrat.frx":4E185
            Key             =   "Delete"
         EndProperty
         BeginProperty ListImage3 {2C247F27-8591-11D1-B16A-00C0F0283628} 
            Picture         =   "Kzatrat.frx":4E297
            Key             =   "OOFL"
         EndProperty
      EndProperty
   End
...
'Mconn.Execute ("UPDATE Tarif INNER JOIN TipKv ON Tarif.KodKV = TipKv.Код SET Tarif.NameKV = [TipKv]![Name_Kv]")
...
rs_kat.AddNew
'rs_kat("Код") = n + 1
rs_kat("Name") = "Новая категория затрат"
rs_kat("KodPlan") = 0
rs_kat.UpdateBatch
Fg1.DataRefresh
rs_kat.MoveLast
...
If (Fg1.TextMatrix(0, Fg1.Col)) = "затр. план." Then
Cl = ""
Combo_RS.MoveFirst
Do While Not Combo_RS.EOF
'cl = cl + Combo_RS("Name_Kategor") + "|"
Cl = Cl + CStr(Combo_RS("Schet")) & vbTab & Combo_RS("Schet_Name") + "|"
Combo_RS.MoveNext
Loop
Fg1.ComboList = Cl
'Else: FG1.ComboList = ""
...
'создаем рекордсет для падающего списка затрат ПЛАНОВЫХ
rs_kat.CursorType = adOpenForwardOnly
rs_kat.LockType = adLockBatchOptimistic
rs_kat.Open ("SELECT SprZatrFakt.Код, SprZatrFakt.KodPlan, SprZatrFakt.Name FROM SprZatrFakt"), Mconn
Set Fg1.DataSource = rs_kat
Combo_RS.Open ("SELECT Schet.Schet, Schet.Schet_Name FROM Schet"), Zconn
